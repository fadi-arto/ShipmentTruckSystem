                        ...
                        <div class="peer peer-greed">
                            <a class="sidebar-link td-n" href="/">
                                <div class="peers ai-c fxw-nw">
                                    <div class="peer">
                                        <div class="logo">
                                            <!-- <img :src="imagees" alt="any"> -->
                                            <v-img src="./STSB.png" alt="John"></v-img>
                                        </div>
                                    </div>
                                    <div class="peer peer-greed">
                ...
                <ul class="sidebar-menu scrollable pos-r" style="padding:0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu tabless">
                            ...
                            <li>
                                <a class='sidebar-link' @click="pages('ADD_Vechile')">ADD vechile</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu tabless">
                            ...
                            <li>
                                <a class='sidebar-link' @click="pages('Add_Center')">Add Centers</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="dropdown-toggle" aria-expanded="false" @click="pages('List_Shipment')">
                            <span class="icon-holder">
                                <i class="c-red-600 ti-home"></i>
                            </span>
                    ...
                    <li class="nav-item dropdown">
                        <a class="dropdown-toggle" aria-expanded="false" @click="pages('List_Plan')">
                            <span class="icon-holder">
                                <i class="c-red-600 ti-home"></i>
                            </span>
            ...
            <div class="home">
                ...
                <main class="main-content" style="    padding: 23px 0px 0px;">
                    <div id="mainContent">
                        ...
                        <div class="Add_Center" style="margin: 11px;" v-if="show === 'Add_Center'">
                            <Add_Center />
                        </div>
                        <div class="ADD_Vechile" style="margin: 11px;" v-if="show === 'ADD_Vechile'">
                            <ADD_Vechile />
                        </div>
                    </div>
                </main>
...
import Chart_Areas from '../components/Company/Charts/Chart_Area'
import Chart_Lines from '../components/Company/Charts/Cart_Line.vue';
import Add_Center from '../components/Company/Centers/Add_Center.vue';
import Dashboard from '../components/Company/Home/main'
...
import List_Shipment from '../components/Company/Shipment/Shipment'
import List_Plan from '../components/Company/Plan/ListPlan'
import All_Chart from '../components/Company/Charts/Chart.vue'
import Email from '../components/Company/Email/Email.vue'
...
import ADD_Vechile from '../components/vechile/Add-vechile.vue';
...
export default {
    ...
    methods: {
            async  images(){
      await axios.get('http://localhost:3000/mangecompany/GET_IMAGE', {withCredentials: true})
            .then((res) => {
                console.log(res)

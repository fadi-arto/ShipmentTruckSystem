<template>
  ...
  top: 5%;">
    <div class="peers ai-s fxw-nw h-100vh">
      <div
        class="d-n@sm- peer peer-greed h-100 pos-r bgr-n bgpX-c bgpY-c bgsz-cv imagess"
      ></div>
      <div
      ...
      >
        ...
        <form>
          <div class="mb-3">
            <label class="text-normal text-dark form-label">KEY</label>
            <input
              type="text"
              v-model="email"
              class="form-control"
  ...
  methods: {
    async SignIES() {
      try {
        ...
        if (response.data === "Signed in Center") {
